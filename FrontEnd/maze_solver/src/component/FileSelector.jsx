    ...
    const handleData=(e)=>{
      ...
      if(TrainData){
        return (<Stack gap={3} direction={"row"}>
          ...
          <DescriptionIcon sx={{fontSize:60,color:"#1d6c41"}}/>
          
          <Typography color='#1d6c41' variant='h6' fontWeight={600}>{fileName}</Typography>
          ...
          <Stack gap={1} alignItems={'center'} >
            <Box sx={{display:"flex",alignItems:"center",gap:"4px"}}>
              ...
              <Typography fontWeight={500} sx={{}} >{status?`Trained Rate:${rate*100}%`:"Perceptron Untrained"}</Typography>
            </Box>
